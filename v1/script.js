...
async function loadFacts() {
  const res = await fetch(
    "https://fakjalpdywwtzbslvnwr.supabase.co/rest/v1/Facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZha2phbHBkeXd3dHpic2x2bndyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDY5MjQ1OTksImV4cCI6MjAyMjUwMDU5OX0.6vDWGrzN_eXVS9ciQHfkJhVvrqpnbbXUONZKnXfSnBA",
      },
    }
  );
